        ...
        <div class="screen-left-top">
          ...
          <div class="date-swiper">
            <swiper :options="dateSwiperOption" ref="dateSwiper">
              ...
              <div class="swiper-button-prev swiper-button-white prev-next" slot="button-prev"></div>
              <div class="swiper-button-next swiper-button-white prev-next" slot="button-next"></div>
            </swiper>
          </div>
        </div>
